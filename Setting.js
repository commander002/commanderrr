...
global.owner = process.env.OWNER_NUMBER  || '923084713397' ;  // ADD YOUR NUMBER WITHOUT +
global.mongodb = process.env.MONGODB_URI || " ac-ozd8ub9-shard-00-01.qcr0rzg.mongodb.net:27017" ;            // PUT MONGODB KEY HERE, WITHOUT MONGODB YOUR BOT WILL NOT RUN
...
global.sudo  =  process.env.SUDO || "923084713397" ;          // DON'T REMOVE
global.mztit = process.env.MZTIT ||"𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒",               // ADD YOUR TITLE, ONE WORD WILL BE MORE BETTER
...
module.exports = {
  ...
  //==============================[COMPULSORY]=====================================
  sessionName: process.env.SESSION_ID || '28_03_2024_SIGMA_MD_rfW4r0Fc_MAHER_ZUBAIR',              // PUT YOUR SESSION ID
  botname: process.env.BOT_NAME       || '𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒',         // ADD YOUR BOT NAME
  ownername:  process.env.OWNER_NAME  || `𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒`, // ADD YOUR NAME
  ...
  //==============================[WHAT'SAPP FEATURES]==============================
  author:  process.env.PACK_AUTHER  || '𝘾𝞗𝞛𝞛𝞓𝞜𝘿𝞢𝞒',      // ADD YOUR STICKER AUTHOR NAME
  ...
  packname:  process.env.PACK_NAME  || "𝐘𝐎𝐔𝐑𝐒𝐓𝐑𝐔𝐋𝐘" ,          // ADD YOUR STICKER PACKNAME
